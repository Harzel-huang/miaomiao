  ...
  <div class="search_body">
    <div class="search_input">
      <div class="search_input_wrapper">
		...
		<!-- //@keyup.enter="searchkey(searchkw) 来触发事假请求 -->
...
export default {
  ...
  watch: {
    searchkw(newkey) {
      this.axios.get("/api/searchList?cityId=10&kw=" + newkey).then(res => {
        var msg = res.data.msg;
        var movielist = res.data.data.movies;
        if (msg === "ok" && movielist != null) {
...
//   methods: {
//     searchkey(searchkw) {
//       this.axios.get("/api/searchList?cityId=10&kw=" + searchkw).then(res => {
//         var msg = res.data.msg;
//         var movielist = res.data.data.movies;
//         if (msg === "ok" && movielist != null) {
//           this.movielist = movielist.list;
